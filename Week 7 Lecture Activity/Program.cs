...
namespace Week_7_Lecture_Activity
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // arrayl decloration and setting values
            ...
            array1[0] = 5; // sets the value index 0 to 5
            array1[1] = 10; // sets the value index 1 to 10
            array1[2] = 15; // sets the value index 1 to 15
            array1[3] = 20; // sets the value index 1 to 20
            array1[4] = 25; // sets the value index 1 to 25
        ...
        static void ArrayTrabersal(string array)
        {
            // you can use a for-loop or other looping statements for array traversals
            for (int i = 0; i < array.Length; i++)
            {
                Console.WriteLine($"Array at index {i}: {array[1]}");
            }
        }
